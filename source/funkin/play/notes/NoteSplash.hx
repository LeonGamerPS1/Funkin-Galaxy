...
class NoteSplash extends FlxSprite
{
	...
	function setup():Void
	{
		if (frameCollection?.parent?.isDestroyed ?? false)
	...
	public function play(direction:Int, variant:Int = null):NoteSplash
	{
		if (variant == null)
			variant = FlxG.random.int(1, 2);
