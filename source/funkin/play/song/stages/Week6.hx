...
class Week6 extends BaseStage
{
	...
	override function create()
	{
		...
		var bgSchool:BGSprite = new BGSprite('weeb/weebSchool', repositionShit - 250, 8, 0.6, 0.90);
		add(bgSchool);
		...
		var bgTrees:FlxSprite = new FlxSprite(repositionShit - 380, -1500);
