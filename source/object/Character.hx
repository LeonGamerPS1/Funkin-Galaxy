...
class Character extends FlxSprite
{
	...
	public function new(charName:String = 'dad', isPlayer:Bool = false)
	{
		...
		if (Assets.exists('assets/images/${json.texture_path}.png')) // compatibility with fucky psych character paths
	...
	override function update(elapsed:Float)
	{
		...
		{
			case 'pico-speaker':
				if (animationNotes.length > 0 && Conductor.instance.time > animationNotes[0][0])
				{
					var noteData:Int = 1;
