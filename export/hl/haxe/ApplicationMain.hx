...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("untitled rhythm game", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("untitled rhythm game", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "untitled rhythm game";
		app.meta["name"] = "untitled rhythm game";
		...
		#elseif air
		app.window.title = "untitled rhythm game";
		#else
